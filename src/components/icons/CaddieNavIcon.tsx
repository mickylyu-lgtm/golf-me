...
export function CaddieNavIcon({ size = 24, strokeWidth = 2.1, className }: CaddieNavIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      {/* "AI" lettering — sized and positioned to sit centered within
          the cap's dome (clear of both the peak at y≈2.6 and the brim
          seam below) rather than pinned to one edge */}
      <text x="12" y="7.3" textAnchor="middle" fontSize="5.8" fontWeight="900" fill="currentColor" stroke="none" fontFamily="system-ui, sans-serif" letterSpacing="-0.2">
        AI
      </text>
